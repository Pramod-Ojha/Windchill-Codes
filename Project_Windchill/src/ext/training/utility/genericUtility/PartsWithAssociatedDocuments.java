...
public class PartsWithAssociatedDocuments implements RemoteAccess, Serializable{
	...
	public static void main(String[] args) throws Exception{
		...
		findPartsWithDocuments();

	}

	private static void findPartsWithDocuments() throws Exception{
		
		QuerySpec querySpecPart = new QuerySpec(WTPart.class);
		
		// Joining WTPart with WTDocumentLink
	//	int partIndex = querySpecPart.addClassList(WTPart.class, true);
	//	int linkIndex = querySpecPart.addClassList(WTPartDocumentLink.class, true);
		
		querySpecPart.appendWhere(new SearchCondition(WTPart.class, WTPart.NUMBER, SearchCondition.LIKE, "GPLM%"), new int[] {0});
