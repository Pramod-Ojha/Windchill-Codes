 ...
 */
public class CheckInWTDocument implements RemoteAccess, Serializable {
        ...
        try {
            ...
            if (queryResult.hasMoreElements()) {
                ...
                if (WorkInProgressHelper.isCheckedOut(latestDoc)) {
                    ...
                    WorkInProgressHelper.service.checkin(latestDoc, "Checked-In through code for training - 6");
