    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            querySpecPart.appendWhere(
                    new SearchCondition(WTPart.class, WTPart.NAME, SearchCondition.EQUAL, "TestPart0"), null);
            ...
            if (queryResult.hasMoreElements()) { 
                ...
                if (latestResult.hasMoreElements()) {
                    ...
                    if (WorkInProgressHelper.isCheckedOut(latestObject)) {
                        ...
                        WorkInProgressHelper.service.checkin((Workable) latestObject, "Checked In through code for training- 5");
